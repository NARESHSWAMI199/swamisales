...
const columns: GridColDef[] = [
    ...
    { cell: 'status', headerName: 'Status', width: 90 ,
         valueGetter: (params: GridValueGetterParams) => {
             if (params.row.status === 'A') return (<a href='' className='badge badge-success'>Active</a>)
             else return (<a href='' className='badge badge-success'>Deactive</a>)
         }
