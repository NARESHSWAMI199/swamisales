...
function Dashborad() {
  ...
  return (
        ...
        <div className='row'>
          <div className='col-md-4 mt-1 gredint-box'>
          ...
          {/* Users */}
          <div className='col-md-4 -box mt-1'>
              <div className='shadow-sm  gredint-box py-2'>
                  <div className='rounded'>
                      <div className=''>
 ...
 {/* Sfaffs */}
          ...
          <div className='col-md-4 gredint-box mt-1'>
              <div className='shadow-sm p-5'>
                  <div className='rounded'>
                      <div className=''>
          ...
          <div className='col-md-4 gredint-box'>
              <div className='shadow-sm p-5'>
                  <div className='rounded'>
                      <div className=''>
                          <h1 className='mt-5 text-center'>Retailers <br /> <span className="big-text">{JSON.stringify(staff.total_staff)}</span></h1>
                          <hr className='vr border'></hr>
                      ...
                      {/* <label> <small>Recent users :</small></label> */}
                      <Menu>
                          <SubMenu label='Recent retailers :'>
                              {recentStaffs.map((i, key) => {
                                  return (<>
                                      <MenuItem key={key}> <img height={20} width={30} src={host + i.image} /> {i.username}</MenuItem>
                                  </>)
