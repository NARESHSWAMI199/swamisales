...
const columns: GridColDef[] = [
    ...
    { field: 'is_staff', headerName: 'Staff', width: 90 ,
        renderCell: (params: GridValueGetterParams) => {
            if (params.row.is_staff) return (<div className='text-center'><Link to='/' className='badge badge-success'>Yes</Link></div>)
            else return (<Link to='' className='badge badge-warning'>No</Link>)
        }
},

    {
        ...
        renderCell: (params: GridValueGetterParams) => {
            if (params.row.status === 'A') return (<div className='text-center'><Link to="/" className='badge badge-success'>Active</Link></div>)
            else return (<Link to='' className='badge badge-warning'>Deactive</Link>)
        }
