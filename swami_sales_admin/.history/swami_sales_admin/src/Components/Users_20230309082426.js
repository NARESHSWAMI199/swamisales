...
const columns: GridColDef[] = [
    ...
    { field: 'status', headerName: 'Status', width: 90 ,
         valueGetter: (params: GridValueGetterParams) => {
             if (params.row.status === 'A') return (<button className='badge badge-success'>Active</button>)
             else return (JSON.stringify(<button className='badge badge-success'>Deactive</button>))
         }
