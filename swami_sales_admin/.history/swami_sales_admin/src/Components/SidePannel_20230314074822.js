...
import {Sidebar, Menu, MenuItem,SideMenu,useProSidebar, sidebarClasses } from "react-pro-sidebar";
  ...
  return ( <>
    ...
    <div className='sidebar'  style={{ display: 'flex', height: '100vh', color:"white" }}>
        ...
        >
          ...
          <SubMenu icon={<ArrowDropDownIcon />} label='Users'>
              <MenuItem icon={<PeopleOutlinedIcon />} component={<Link to="/users" /> }> Users List</MenuItem>
              <MenuItem icon={<PeopleOutlinedIcon />} component={<Link to="/users" />}> Add User</MenuItem>
          </SubMenu>
