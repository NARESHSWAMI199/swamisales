          ...
          <div className='col-md-4 mt-1'>
              <div className='shadow-sm gredint-box  px-5 py-2'>
                  <div className='rounded'>
                      <div className=''>
                          <h1 className='mt-5 text-center'><AddBusinessIcon color='red' fontSize='large'/> Wholesales <br /> <span className="big-text">{JSON.stringify(wholesale.total_wholesale)}</span></h1>
