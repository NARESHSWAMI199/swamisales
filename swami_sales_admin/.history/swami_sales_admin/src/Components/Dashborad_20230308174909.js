...
function Dashborad() {
  ...
  return (
        ...
        <div className='row'>
          ...
          <div className='col-md-4'>
              <div className='shadow-sm p-5'>
                  <div className='gredint-box rounded py-1 px-1'>
                      <div className='mb-3'>
                          <h1 className='big-font mt-5'>Users : {JSON.stringify(users.total_user)}</h1>
                      </div>

                      {/* <label> <small>Recent users :</small></label> */}
                          <Menu>
                          <SubMenu className='text-start' label='Recent wholesales :'>
