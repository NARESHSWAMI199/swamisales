...
const columns: GridColDef[] = [
    ...
    {
        field: 'is_staff', align: 'center', headerName: 'Staff', width: 90 ,
    ...
    {
        field: 'status', align: 'center', headerName: 'Status', width: 90,
        renderCell: (params: GridValueGetterParams) => {
    ...
    {
       field :'' ,align:'center',headerName: 'Detail View', width: 100,
        renderCell: (params: GridValueGetterParams) => {
