...
const columns: GridColDef[] = [
    ...
    { field: 'is_staff', headerName: 'Staff', width: 90 ,
        renderCell: (params: GridValueGetterParams) => {
            if (params.row.is_staff) return (<div key={params.row.id} className='text-center'><Link to='/' className='text-sucess' style={{ textDecoration: 'none' }}><CheckCircleIcon /></Link></div>)
