...
const columns: GridColDef[] = [
...

    {
        ...
        renderCell: (params: GridValueGetterParams) => {
            if (params.row.status === 'A') return (<div key={params.row.id} className='text-center'><Link to="/" className='badge badge-success link' style={{ textDecoration: 'none', color: 'white' }} ><CheckCircleIcon /></Link></div>)
