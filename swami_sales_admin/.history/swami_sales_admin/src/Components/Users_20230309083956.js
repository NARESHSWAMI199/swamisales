...
const columns: GridColDef[] = [
    ...
    { field: 'bio', headerName: 'Bio', width: 90 },
    {
        ...
        renderCell: (params: GridValueGetterParams) => {
            if (params.row.status === 'A') return (<div className='text-center'></div><a href='' className='btn btn-success btn-sm'>Active</a></div>)
            else return (<a href='' className='btn btn-warning btn-sm'>Deactive</a>)
        }
