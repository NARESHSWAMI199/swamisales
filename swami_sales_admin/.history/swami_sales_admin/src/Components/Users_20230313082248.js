...
const columns: GridColDef[] = [
...

    {
       field :'' ,headerName: 'Detail View', width: 100,
        renderCell: (params: GridValueGetterParams) => {
             return (<div key={params.row.id} className='text-center'><Link to={`users/${params.row.username}`} className='link' style={{ textDecoration: 'none', color: 'black' }} ><EditIcon/></Link></div>)
        }
